...
/** Deterministic provider/model used for integration tests; override when needed. */
export const TEST_MODEL = process.env.PI_TEST_MODEL ?? "openai-codex/gpt-5.6-luna:low";
